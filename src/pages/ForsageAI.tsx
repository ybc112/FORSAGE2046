...
function generateReply(input: string, deepThink: boolean): string {
  ...
  if (q.includes('bnb')) {
    body =
      'BNB / USDT 当前约 $688.37，24h -1.42%，置信度 58%。\n\n' +
      '· 技术面：短线从高位回落，价格仍在宽幅震荡区间内。\n' +
      '· 资金面：BNB Chain 生态活跃度仍有支撑，但短期追涨性价比一般。\n' +
      '· 操作建议：偏观望，激进用户可等回踩企稳后分批，短线风控位参考 $674 附近。'
  } else if (q.includes('btc') || q.includes('比特币')) {
    body =
      'BTC / USDT 当前约 $70,901.13，24h -3.55%，置信度 54%。\n\n' +
      '· 多空胶着，短线跌幅扩大，仍处于关键区间震荡。\n' +
      '· 建议观望，等待 $70,000 附近支撑确认或放量收复短期均线后再跟进。'
  } else if (q.includes('eth') || q.includes('以太')) {
    body =
      'ETH / USDT 当前约 $1,999.30，24h -0.05%，置信度 56%。\n\n' +
      '· ETH 短线相对横盘，强弱跟随大盘节奏。\n' +
      '· 暂不追涨，可关注 $1,956 附近低点支撑和 $2,009 附近短线压力。'
    ...
    body =
      'FORSAGE 暂未在主流公开行情源查到稳定的实时 USDT 报价，因此不建议直接按固定价格判断。\n\n' +
      '· 生态闭环：发币 → 发射 → Swap → 质押 → 预测，相互导流。\n' +
      '· 如果要评估价格，应优先查看链上池子深度、最近成交、滑点和买卖盘变化。\n' +
      '· 注意：新项目波动大，建议仓位可控、分批参与，不要用未验证报价做决策。'
